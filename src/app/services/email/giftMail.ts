  ...
  try {
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <h3>景品の受け取りについて</h3>
        <p>受け取りはクロージングセレモニー(4/25 12:30~)閉会後にお渡しします。<br>受け取りの際は、こちらのメールかアプリのアカウントがわかるものをお持ちください<br>(スクリーンショット等は場合によってお断りさせていただくことがあります。)</p>
...
受け取りはクロージングセレモニー(4/25 12:30~)閉会後にお渡しします。
